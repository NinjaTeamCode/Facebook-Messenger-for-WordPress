    ...
    <div class="wrap">
        ...
        <?php settings_fields("wap_form_messenger") ?>
            <table class="form-table">
                ...
                <tr valign="top">
                    <th scope="row"><label for="facebook_messenger_text_botton"><?php echo __("Get pro verstion","fb_messenger") ?></label></th>
                    <td>
                        <a href="https://codecanyon.net/item/facebook-messenger-for-wordpress/16392065?utm_source=FB-Messenger-WordPress-org">Download</a>
                    </td>
                </tr>
             </table>
